...
const styles = {
  ...
  pageTitle: { fontSize: '22px', color: '#1a1a2e', marginBottom: '20px' },
  toolbar: { display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' },
  searchInput: { padding: '8px 12px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '14px', flex: 1, minWidth: '200px' },
  ...
  deactivateBtn: { padding: '4px 10px', backgroundColor: '#fee2e2', color: '#dc2626', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '13px' },
