...
const s = {
  ...
  statsRow: { display: 'flex', gap: '14px', marginBottom: '22px', flexWrap: 'wrap' },
  statCard: { flex: '1 1 180px', backgroundColor: theme.color.surface, borderRadius: theme.radius.md, padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '6px', border: `1px solid ${theme.color.border}` },
